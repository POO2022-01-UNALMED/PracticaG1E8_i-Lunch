...
public class DatosAleatorios {
	...
	public static String[] nombresAleatorios = { "Yasemin Phillips", "Lavinia Banks", "Kodi Paine", "Phebe Beaumont",
			...
			"Anastasia Mckeown", "Vivaan Craft",
			"Leonie Hardin",
			"Naima Peck",
			"Sammy-Jo Hollis",
			"Gus Jefferson",
	...
	public static String[] productosAleatorios = { "Pizza", "Hamburguesa", "Bandeja Paisa", "Sushi", "Empanadas", "Pollo frito",
			"Spaghetti", "Paella", "Tacos" };

	// Tipos de cargos en la cocina
	public static String[] cargosEnCocina = { "Chef en jefe", "Chef ejecutivo", "Chef general", "Chef repostero",
			"Lavaplatos" };
	...
	// Tipos de vehiculos
	public static String[] tiposVehiculos = { "Automovil", "Motoicicleta", "Bicicleta", "Cuatrimoto", "Monopatin", "Helicoptero",
